...
namespace LibCLCC.NET.TextProcessing
{
    ...
    public class RefSegment
    {
        ...
        /// </summary>
        [NonSerialized]
        public RefSegment Prev = null;
        /// <summary>
        /// Next Segment
        /// </summary>
        [NonSerialized]
        public RefSegment Next = null;
        /// <summary>
        /// Content
        /// </summary>
        public RefString content = "";
        /// <summary>
        /// Is Encapsulated
        /// </summary>
        ...
        /// <param name="R"></param>
        /// <returns></returns>
        public static bool operator <(RefSegment L, RefSegment R)
        {
        ...
        /// <param name="L"></param>
        /// <param name="R"></param>
        public static void Concatenate(RefSegment L, RefSegment R)
        {
            if (L.Next == null)
            {
                L.Next = R;
        ...
        /// </summary>
        /// <param name="R"></param>
        public void Concatenate(RefSegment R)
        {
            Concatenate(this, R);
        }
        /// <summary>
        ...
        /// </summary>
        /// <returns></returns>
        public RefSegment Duplicate()
        {
            RefSegment segment = new RefSegment();
            segment.Prev = Prev;
            segment.Next = Next;
        ...
        /// <param name="L"></param>
        /// <param name="R"></param>
        public static void Substitute(RefSegment New, RefSegment L, RefSegment R)
        {
            New.Prev = L.Prev;
            if (L.Prev != null)
            {
